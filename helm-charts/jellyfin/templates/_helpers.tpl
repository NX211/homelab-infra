...
Watchstate labels
*/}}
{{- define "jellyfin.watchstate.labels" -}}
helm.sh/chart: {{ include "jellyfin.chart" . }}
app.kubernetes.io/name: {{ include "jellyfin.name" . }}-watchstate
app.kubernetes.io/instance: {{ .Release.Name }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
...
{{/*
Watchstate selector labels
*/}}
{{- define "jellyfin.watchstate.selectorLabels" -}}
app.kubernetes.io/name: {{ include "jellyfin.name" . }}-watchstate
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
